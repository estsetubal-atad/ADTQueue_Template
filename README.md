...
```bash
$> git clone https://github.com/estsetubal-atad/ADTQueue_Template.git <program-dir-name>
```
...
```bash
$> git clone https://github.com/estsetubal-atad/ADTQueue_Template.git MyQueueCProgram
$> code MyOwnCProgram
```
